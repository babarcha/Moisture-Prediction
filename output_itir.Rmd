...
setDT(data_isosuo_weather)[, water_height1 := setDT(data_ground_level)[data_isosuo_weather, water_height1, on = "timestamp", roll = "nearest"]]
setDT(data_isosuo_weather)[, water_height2 := setDT(data_ground_level)[data_isosuo_weather, water_height2, on = "timestamp", roll = "nearest"]]



setDT(data_ground_level)[data_isosuo_weather, timestamp, roll = "nearest", on = "timestamp"]
